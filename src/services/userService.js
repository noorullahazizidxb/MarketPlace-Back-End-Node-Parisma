...
export const userService = {
  ...
  async loginWithSocialProfile({ provider, providerAccountId, email, firstName, lastName, fullName, photo }) {
    ...
    if (!user) {
      ...
      await prisma.userRole.create({ data: { userId: user.id, role: 'USER' } });
    } else {
      const nextMetadata = {
      ...
      await userRepository.update(user.id, {
        ...
        photo: user.photo || photo || undefined,
